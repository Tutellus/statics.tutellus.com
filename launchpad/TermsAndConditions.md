...
La adquisición de la condición de Usuario implica la lectura y aceptación expresa y sin reserva alguna de los términos integrantes de los presentes T&CG, del Aviso Legal y la Política de Privacidad.
...
Igualmente, Tutellus se reserva el derecho a suspender cautelarmente las operaciones del Usuario y bloquear el uso del servicio, hasta que haya podido confirmar y verificar la legalidad y legitimidad de las operaciones.
...
El Usuario, independientemente de su nivel, deberá elegir una de las siguientes facciones:
...
Tutellus no será responsable en los supuestos de incumplimiento de los términos y condiciones acordados entre el responsable del lanzamiento del Token y Usuario en los Whitepaper de cada IDO.
...
No obstante, y en cumplimiento con lo establecido en el [artículo 28 de la Ley 34/2002 de 11 de julio de Servicios de la sociedad de información y de comercio electrónico (LSSI)](https://www.boe.es/buscar/act.php?id=BOE-A-2002-13758#a28), en el plazo máximo de veinticuatro horas desde la entrada en vigor de las CONDICIONES PARTICULARES, Tutellus confirmará la aceptación de las mismas confirmando la entrada en vigor del contrato.

## 15. PROTECCIÓN DE DATOS

Tutellus se compromete a proteger la privacidad y proporcionar una experiencia de Usuario segura. Al contratar los servicios prestados en Tutellus, el Usuario acepta explícitamente el tratamiento de sus datos tal como se describe en la Política de Privacidad establecida por Tutellus en <https://www.tutellus.com/informacion/terminos-y-condiciones>.

En particular, el Usuario conoce y acepta que las órdenes de compra realizadas quedan registradas de forma seudonimizada en la Tecnología de Registro Distribuido o Blockchain donde se encuentren desplegados los contratos inteligentes, no pudiendo ser las mismas eliminadas o borradas. El registro seudonimizado permitirá a TUTELLUS y los emisores de las IDO trazar la identidad y transacciones realizadas exclusivamente por el Usuario en la Blockchain, y por tanto la posibilidad de vincular las mimas al Usuario poseedor de los tokens o criptoactivos. Una vez finalizada la prestación de los servicios o ejercido por el usuario el derecho de supresión, TUTELLUS y los emisores estarán obligadas a suprimir los datos bloqueando el tratamiento de los mismos, debiendo quedar a disposición de la autoridad competente jueces y tribunales por los plazos de prescripción de las acciones legales que en defensa le correspondan a estas últimas. Una vez finalizado el plazo indicado, TUTELLUS y los emisores de las IDO eliminarán la vinculación al registro seudonimizado que permitía identificar los registros con la identidad del usuario, garantizando de esta forma el derecho a la supresión del dato personal. TUTELLUS y los emisores de las IDO no se hacen responsable de las revelaciones de identidad que se produzcan por el usuario o por terceros.

En cumplimiento de lo establecido en el Reglamento (UE) 2016/ 679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016 (en adelante, RGPD) la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales (en adelante, LOPDGDD) y cualquier otra normativa de protección de datos aplicable, le informamos que los datos personales comunicados serán incorporados a una Base de Datos de información titularidad de TUTELLUS. La finalidad del tratamiento es la prestación de los servicios de la Plataforma, incluido el servicio Launchpad, con base en el consentimiento prestado y el interés legítimo en el establecimiento y desarrollo de relaciones comerciales.

Sus datos se conservarán durante el tiempo necesario para la finalidad del tratamiento o cuando solicite la supresión de los mismo, y una vez finalizada la misma o suprimidos los datos, se mantendrán a disposición de la administración pública, jueces y tribunales durante el plazo previsto de prescripción de las acciones que resulten de aplicación al tratamiento de sus datos. Para cualquier asunto relacionado con el tratamiento de datos de personas físicas por parte de TUTELLUS podrá dirigirse a la siguiente dirección de correo electrónico **rgpd@tutellus.com**.

Los datos personales que se marcan con un asterisco en el formulario de identificación son imprescindibles para la finalidad expuesta, la ausencia de dichos datos implicaría la imposibilidad de uso de los servicios de la Plataforma.
...
Le informamos de que con la aceptación del Whitepaper del CLIENTE, éste último se configurará igualmente como Responsable de Tratamiento de todos aquellos datos de la inscripción, comercialización y adquisición así como los datos necesarios para la identificación de los usuarios que se han inscrito y adquirido los tokens en el momento de cierre de la IDO. Por lo tanto, ambas partes se constituyen como Responsables del tratamiento de los datos de comercialización, adquisición e identificación de los usuarios, conforme a lo establecido en los presentes Términos y Condiciones y el Whitepaper de la IDO.

En concreto, todos los datos de carácter personal que identifican al usuario que se haya inscrito y adquirido los tokens serán facilitados a los emisores de la correspondiente IDO para cumplir con la normativa vigente, en concreto, con el posible cumplimiento de lo establecido para la condición de sujeto obligado por la Ley 10/2010, de 28 de abril, de prevención del blanqueo de capitales y de la financiación del terrorismo o cualquier otra normativa relacionada y que pudiera aplicarse en el futuro a la actividad indicada en los presentes TCG.
...
## 19. NULIDAD DE ALGUNA DISPOSICIÓN
